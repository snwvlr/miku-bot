...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('smug')
        .setDescription('😏 Ficar convencido'),
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('smug');
            const soloMessages = ["está convencido(a)!","fez cara de smug!","está se achando!"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `😏 Smug • ${gif.anime_name || 'Anime'}` }
            });
