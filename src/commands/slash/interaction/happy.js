...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('happy');
            const soloMessages = ["está muito feliz!","está radiante!","está super alegre!"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `😄 Happy • ${gif.anime_name || 'Anime'}` }
            });
