...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('angry')
        .setDescription('😠 Ficar com raiva'),
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('angry');
            const soloMessages = ["está com raiva!","está irritado(a)!","está bravo(a)!"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `😠 Angry • ${gif.anime_name || 'Anime'}` }
            });
