...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('feed')
        .setDescription('🍕 Alimentar alguém')
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('feed');
            const messages = ["alimentou","deu comidinha para","fez um nhac nhac com"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `🍕 Feed • ${gif.anime_name || 'Anime'}` }
            });
