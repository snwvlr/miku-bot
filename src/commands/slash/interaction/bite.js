...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('bite');
            const messages = ["mordeu","deu uma mordidinha em","nhac! mordeu"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `😬 Bite • ${gif.anime_name || 'Anime'}` }
            });
