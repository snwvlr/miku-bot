...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('poke');
            const messages = ["cutucou","ficou cutucando","poke poke em"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `👉 Poke • ${gif.anime_name || 'Anime'}` }
            });
