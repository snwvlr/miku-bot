...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('nod')
        .setDescription('😌 Acenar com a cabeça'),
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('nod');
            const soloMessages = ["acenou com a cabeça","concordou","fez sim com a cabeça"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `😌 Nod • ${gif.anime_name || 'Anime'}` }
            });
