...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('bonk');
            const messages = ["deu um bonk em","BONK em","acertou um bonk em"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `🔨 Bonk • ${gif.anime_name || 'Anime'}` }
            });
