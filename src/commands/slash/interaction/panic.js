...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('panic')
        .setDescription('😱 Entrar em pânico'),
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('panic');
            const soloMessages = ["está em pânico!","AAAAAAH!","está surtando!"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `😱 Panic • ${gif.anime_name || 'Anime'}` }
            });
