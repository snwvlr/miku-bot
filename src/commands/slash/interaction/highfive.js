...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('highfive')
        .setDescription('🙌 Dar um high five alguém')
    ...
    async execute(interaction) {
        ...
        try {
            const gif = await nekos.getGif('highfive');
            const messages = ["deu um high five em","fez high five com","bateu a mão com"];
            ...
            const embed = EmbedUtils.interaction({
                ...
                footer: { text: `🙌 Highfive • ${gif.anime_name || 'Anime'}` }
            });
